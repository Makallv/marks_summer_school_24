...
describe("Register a new account", () => {
  ...
  it("User can't register with out first name", () => {
    Pages.loginPage.registerLink.click();
    Pages.registerPage.registerFunc("", RANDOM_LAST_NAME, RANDOM_EMAIL, RANDOM_PASSWORD);
    Pages.registerPage.checkInputs("", RANDOM_LAST_NAME, RANDOM_EMAIL, RANDOM_PASSWORD);
    Pages.registerPage.registerButton.click();
    Pages.homePage.productArray.should("not.exist");
  });
  ...
  it("User can't register with incorrect email format", () => {
    Pages.loginPage.registerLink.click();
    Pages.registerPage.registerFunc(RANDOM_FIRST_NAME, RANDOM_LAST_NAME, RANDOM_FIRST_NAME, RANDOM_PASSWORD);
    Pages.registerPage.checkInputs(RANDOM_FIRST_NAME, RANDOM_LAST_NAME, RANDOM_FIRST_NAME, RANDOM_PASSWORD);
    Pages.registerPage.registerButton.click();
    Pages.homePage.productArray.should("not.exist");
  });
  ...
  it("User can't register by using the same email", () => {
    ...
    cy.fixture('user/user').then((userJson) => {
      Pages.registerPage.registerFunc(RANDOM_FIRST_NAME, RANDOM_LAST_NAME, userJson["username"], RANDOM_PASSWORD)
      Pages.registerPage.checkInputs(RANDOM_FIRST_NAME, RANDOM_LAST_NAME, userJson["username"], RANDOM_PASSWORD)
    });
    Pages.registerPage.registerButton.click()
    Pages.registerPage.registerError.should('have.text', 'Error: A customer with the given email already has an account. Log in instead.')
  })
});
